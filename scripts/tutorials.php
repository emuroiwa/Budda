...
<script language="javascript">
 ...
 location = 'index.php?page=tutorials.php'
  </script>
  <?php
  exit;
   }
...
$question = $_POST['name']; 
$rs1 = mysql_query("select * from tutorials where name = '$_POST[question]'");
 ...
 location = 'index.php?page=tutorials.php'
  ...
  exit;
	  ...
	  $fn = time().$_FILES['file']['name'];
		  	if(!move_uploaded_file($_FILES['file']['tmp_name'],"pic/".$fn)){?>
        <script language="javascript">
        ...
        <?php
		exit;}
$result = mysql_query("INSERT INTO tutorials(name,dept,moduleid,username,document)VALUES('$question','$dept','$_POST[moduleid]','$_SESSION[username]','$fn')") or die (mysql_error());
if ($result )
{
 ?>
<script language="javascript">
...
<table width="100%" border="0" align="center" style="border-bottom:3px solid #000000;">
      ...
      <tr>
        <td colspan="2" align="center"><div align="center"><span class="style7">Add New Tutorials</span></div></td>
      </tr>
  
<tr>
  <td width="39%"> <span class="style1 style9">Tutorial Name</span></td>
  <td width="61%">
<input type="type" name="name" class="ed" id="name"  required>    </td>
</tr><tr>
  <td width="39%"> <span class="style1 style9">Tutorials</span></td>
  <td width="61%">
<input type="file" name="file" class="ed" id="file" required>    </td>
</tr>
 <tr>
            <td width="140"><span class="style12 style1">You Tutorial Listing</span></td>
            <td width="412">
              <?php 
include 'opendb.php';
...
$rez=mysql_query($sql);
echo "<select name='moduleid' id='moduleid'>";
