...
<body style="margin: 0px;">
	    ...
	    <form name="form1" method="post" action="index.php?page=edit.php">
	   
	  
	  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5" style="border-bottom:3px solid #000000;">
<tbody>
	            <tr align="center">
	        <td colspan="2" class="style8 style2 style9"><p class="style11"><u> Edit Questions Module</u></p>
	          <p class="style13">Select questions below to edit/delete</p>	          </td>
	        <tr>
            <td width="266"><span class="style12">Questions</span></td>
            <td width="583">
              <?php 
include 'opendb.php';
...
?>
<!--<option value=" ">--- <span class="style12">Select questions </span>---</option>-->
<?php
