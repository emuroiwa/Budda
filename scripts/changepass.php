...
//-->
					  ...
					  <form action="" method="POST" enctype="multipart/form-data" name="form1" id="form1" onSubmit="MM_validateForm('oldpass','','R','password','','R','cpass','','R');return document.MM_returnValue">
